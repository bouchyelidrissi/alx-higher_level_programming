...
It also contains a public instance method called my_print,
which prints the square to stdout.
"""
...
class Square:
    ...
    a public area method, and getter and setter methods for the size
    attribute.
    It also contains a public instance method called my_print, which
